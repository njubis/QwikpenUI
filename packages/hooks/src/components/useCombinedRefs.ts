...
/**
 * This hook merges a consumer passed ref with our internal ref. 
 * It allows consumers to pass a reference to the component and get access to the underlying element. 
* 
* */
...
export function useCombinedRef(externalRef: any, ctxOpts?: CtxOpts) {
  ...
  if (!mergedRef) {
    throw new Error(
      'useCombinedRef could not find the ref. Please pass a ref to the component.',
    );
  }
